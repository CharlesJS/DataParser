...
@Suite struct EncodingTests {
    ...
    private func checkCollection(_ collection: some RangeReplaceableCollection<UInt8>) {
        ...
        #expect(Array(c) == [0x01, 0x02])

        c.append(Int8(0x03), byteOrder: .little)
        #expect(Array(c) == [0x01, 0x02, 0x03])

        c.append(Int8(0x04), byteOrder: .big)
        #expect(Array(c) == [0x01, 0x02, 0x03, 0x04])

        c.append(UInt16(0x0506), byteOrder: .little)
        #expect(Array(c) == [0x01, 0x02, 0x03, 0x04, 0x06, 0x05])

        c.append(UInt16(0x0708), byteOrder: .big)
        #expect(Array(c) == [0x01, 0x02, 0x03, 0x04, 0x06, 0x05, 0x07, 0x08])

        c.append(Int16(0x090a), byteOrder: .little)
        #expect(Array(c) == [0x01, 0x02, 0x03, 0x04, 0x06, 0x05, 0x07, 0x08, 0x0a, 0x09])

        c.append(Int16(0x0b0c), byteOrder: .big)
        #expect(Array(c) == [0x01, 0x02, 0x03, 0x04, 0x06, 0x05, 0x07, 0x08, 0x0a, 0x09, 0x0b, 0x0c])
