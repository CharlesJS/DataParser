...
final class DataParserTests: XCTestCase {
    ...
    func testParseSignedIntegers() throws {
        var parser = DataParser(Self.numericTestData)
    ...
    func testParseUnsignedIntegers() throws {
        var parser = DataParser(Self.numericTestData)
    ...
    func testReadingRawBytes() throws {
        var parser = DataParser(Self.numericTestData)
    ...
    func testReadingIntegerArrays() throws {
        var parser = DataParser(Self.numericTestData)
    ...
    func testReadingStrings() throws {
        let stringData: [UInt8] = [
            0x46, 0x6f, 0x6f,                                                 // "Foo"
        ...
        var parser = DataParser(stringData)
    ...
    private func testRead<T: Equatable, DataType: Sequence>(
    ...
    private func runTest<DataType: Sequence, T>(
        _ parser: inout DataParser<DataType>,
        byteCount: Int,
